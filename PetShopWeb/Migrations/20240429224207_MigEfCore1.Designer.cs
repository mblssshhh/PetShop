...
namespace PetShopWeb.Migrations
{
    ...
    [Migration("20240429224207_MigEfCore1")]
    partial class MigEfCore1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetShopWeb.Data.Entity.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetShopWeb.Data.Entity.ClubCard", b =>
                {
                    b.HasOne("PetShopWeb.Data.Entity.Buyer", "Buyer")
                        .WithOne("ClubCard")
                        .HasForeignKey("PetShopWeb.Data.Entity.ClubCard", "BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetShopWeb.Data.Entity.Order", b =>
                {
                    b.HasOne("PetShopWeb.Data.Entity.Basket", "Basket")
                        .WithMany("Orders")
